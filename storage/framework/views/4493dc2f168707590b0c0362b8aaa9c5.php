                ...
                <div class="h-[250px] overflow-y-auto px-4 pb-4 custom-scrollbar">
                    ...
                    <div class="grid grid-cols-8 gap-1">
                        ...
                        <?php $__currentLoopData = $emojis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button onclick="window.insertEmoji('<?php echo e($emoji); ?>')" class="text-[24px] p-1 hover:bg-white/5 rounded transition-all active:scale-90"><?php echo e($emoji); ?></button>
...
<?php /**PATH D:\xampp\htdocs\laravel\chat_app\resources\views/chat/status/text_status.blade.php ENDPATH**/ ?>