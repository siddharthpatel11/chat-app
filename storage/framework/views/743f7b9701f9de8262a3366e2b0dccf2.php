<div id="settings_panel"
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar bg-[#111b21]">
        ...
        <div class="px-6 pt-4 pb-2">
            <h1 class="text-[#e9edef] text-[22px] font-bold mb-4 settings-profile-name"><?php echo e(auth()->user()->name); ?></h1>
            <div
        ...
        <div class="flex flex-col items-center py-6">
            <div class="relative flex flex-col items-center">
                ...
                <div class="bg-[#3b4a54] px-5 py-1.5 rounded-full mb-[-25px] z-10 shadow-xl border border-[#44535c]">
                    <span class="text-[#e9edef] text-[15px] font-medium settings-profile-name"><?php echo e(auth()->user()->name); ?></span>
                </div>
