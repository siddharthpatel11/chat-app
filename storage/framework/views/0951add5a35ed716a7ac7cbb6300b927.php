                ...
                <div class="relative w-12 h-12 shrink-0">
                    <div id="my_status_preview_ring" class="w-12 h-12 rounded-full p-[2px] border-2 border-[#8696a0]">
                        <div id="my_status_preview_inner" class="w-full h-full rounded-full overflow-hidden bg-[#2a3942] flex items-center justify-center">
                            <img id="my_status_avatar" src="<?php echo e(auth()->user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=2a3942&color=fff'); ?>"
...
<?php /**PATH D:\xampp\htdocs\laravel\chat_app\resources\views/chat/status/index.blade.php ENDPATH**/ ?>