...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex w-full h-[100vh] mx-auto overflow-hidden shadow-xl">
        ...
        <div class="flex w-full h-full bg-[#111b21] overflow-hidden border-none">
            ...
            <?php echo $__env->make('chat.nav_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.status.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.status.text_status', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.status.media_status', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.status.status_viewer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.profile_settings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.edit_profile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.general', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_last_seen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_profile_photo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_about', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_exclude_contacts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_blocked_contacts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.privacy_panels.privacy_add_blocked_contact', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.chats', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.chats_panels.chats_modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.chats_panels.chats_upload_quality', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.chats_panels.chats_auto_download', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.chats_panels.chats_wallpaper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.account', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.security_notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.video_voice_panels.video_voice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.notifications_panels.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.notifications_panels.notifications_banner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.notifications_panels.notifications_taskbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.notifications_panels.notifications_subpanel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.help_and_feedback_panels.help_and_feedback', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.settings.keyboard_shortcuts_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.about.about_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.about.about_privacy_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.contacts.contact_info', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.new_chat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.groups.add_group_members', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.groups.create_group', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.contacts.new_contact', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.contacts.edit_contact', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.calls_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.calls_main_column', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.calls.add_favourite_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('chat.media_gallery', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div id="chat_view_container" class="flex-1 flex h-full overflow-hidden relative">
                <?php echo $__env->make('chat.settings_shortcuts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <div id="main_chat_column" class="flex flex-col flex-1 h-full relative transition-all duration-300">
                    ...
                    <?php echo $__env->make('chat.reaction_popup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php echo $__env->make('chat.groups.group_chat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php echo $__env->make('chat.meta_ai', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div id="search_sidebar"
                    ...
                    <div class="p-6 text-center border-t border-gray-800 bg-[#111b21]">
                        <p class="text-[#8696a0] text-[13px] leading-relaxed">
                            Use WhatsApp on your phone to search messages from before <?php echo e(date('d/m/Y')); ?>
    ...
    <script>
        ...
        window.csrf = csrf;
        window.myUserId = <?php echo e(auth()->id() ?? 1); ?>;
        ...
        window.openLiveLocationConfig = function() {
            ...
            const myAvatarIcon = L.divIcon({
                className: 'custom-div-icon',
                html: `<div style="width: 44px; height: 44px; background-color: #202c33; border-radius: 50%; overflow:hidden; border: 2px solid #1dae75; display:flex; justify-content:center; align-items:center; color:white; font-weight:bold; font-size: 20px;"><?php echo e(substr(auth()->user()->name ?? 'Me', 0, 1)); ?></div>`,
                iconSize: [44, 44],
                iconAnchor: [22, 22]
            });
    ...
    <script type="module">
        ...
        window.myUserId = <?php echo e(auth()->id() ?? '0'); ?>;
        window.myUserName = "<?php echo e(auth()->user()->name ?? 'Me'); ?>";
        window.myUserAvatar = "<?php echo e(auth()->user()->avatar ?? ''); ?>";
        window.currentChatId = null;
        window.allContacts = <?php echo json_encode($users ?? [], 15, 512) ?>;
    ...
    <?php echo $__env->make('chat.app_lock', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('chat.add_to_list_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\laravel\chat_app\resources\views/chat/index.blade.php ENDPATH**/ ?>