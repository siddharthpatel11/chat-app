...
class ChannelService
{
    ...
    public function uploadMessageMedia(Request $request)
    {
        ...
        $fileData = $this->fileUploadService->handleMessageFile($request, 'file', 'public');
        
        return response()->json([
            'status' => true,
            'url' => $fileData ? $fileData['file_url'] : null,
            'type' => $fileData ? $fileData['type'] : null,
            'fileName' => $fileData ? $fileData['file_name'] : null
        ]);
    }
