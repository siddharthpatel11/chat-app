...
<div id="active_group_chat_content" class="hidden flex-row flex-1 h-full overflow-hidden select-none">
    ...
    <div id="group_chat_main_column" class="flex-1 flex flex-col relative h-full min-w-0">
        ...
        <div class="flex-1 relative flex flex-col overflow-hidden bg-[#0b141a] chat-bg">
            <div id="group_messages" class="flex-1 overflow-y-auto p-4 space-y-1 scroll-smooth relative z-10 custom-scrollbar">
            </div>
        </div>
        ...
        <div class="h-auto min-h-[64px] bg-[#202c33] px-4 py-2 flex flex-col justify-end shrink-0 relative z-20">
            ...
            <div id="group_normal_input_container" class="flex items-center gap-2 w-full relative">
                ...
                <button id="group_action_btn" onclick="handleGroupActionBtn()"
                    class="bg-[#00a884] hover:bg-[#00bfa5] text-white rounded-full w-11 h-11 flex items-center justify-center shadow-sm shrink-0 transition-colors focus:outline-none">
                    ...
                    <div class="flex items-center gap-3 p-2 select-none" style="min-width: 250px; max-width: 320px;">
                        ...
                        <div class="flex-1 flex flex-col gap-1 min-w-0">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex-1 max-w-[160px] relative flex items-center h-6">
