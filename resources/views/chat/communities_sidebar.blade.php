<div id="communities_sidebar_container"
    ...
    <div class="h-16 bg-[#202c33] flex items-center px-4 justify-between shrink-0 border-b border-[#313d45]">
        <div class="flex items-center gap-3">
            ...
            <button onclick="if(typeof window.showChats === 'function') window.showChats()" class="hidden md:block text-[#aebac1] hover:text-[#e9edef] p-1 rounded-full transition-colors focus:outline-none" title="Back to Chats">
