            ...
            @foreach($settings as $item)
                <div
                    ...
                    <div class="flex-1 ml-3">
                        <h4 class="text-[#e9edef] text-[16px] font-normal leading-tight">{{ $item['title'] }}</h4>
                        <p class="text-[#8696a0] text-[13px] mt-0.5">{{ $item['desc'] }}</p>
                    </div>
                </div>
            @endforeach
...
<script>
    ...
    window.toggleSettings = function() {
        ...
        const settingsPanels = [
            ...
            'chat_backup_panel', 'chat_history_panel', 'notifications_taskbar_panel', 'notifications_banner_panel', 'notifications_subpanel'
        ];
