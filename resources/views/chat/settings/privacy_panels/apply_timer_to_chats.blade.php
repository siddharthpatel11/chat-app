...
<div id="privacy_apply_timer_sidebar" class="hidden flex-col w-full sm:w-[30%] sm:min-w-[350px] border-r border-[#313d45] bg-[#111b21] h-full shrink-0 overflow-hidden relative z-[50]">
    ...
    <div id="privacy_apply_timer_fab" class="hidden absolute bottom-6 right-6 w-14 h-14 bg-[#00a884] hover:bg-[#00bfa5] rounded-full items-center justify-center cursor-pointer shadow-lg transition-transform scale-0" onclick="window.submitApplyTimerToChats()">
