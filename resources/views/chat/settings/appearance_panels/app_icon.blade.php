...
<script>
    ...
    let storedIcon = localStorage.getItem('whatsapp_app_icon_index');
    if (storedIcon !== null) {
        selectedIconIndex = parseInt(storedIcon);
    } else if (window.backendAppearance && window.backendAppearance.app_icon_index !== undefined) {
